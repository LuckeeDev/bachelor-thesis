...
\begin{figure}[htbp]
	...
	\caption{The Sommerfeld enhancement factor for three different values of \(M_{DM} \). The graph ranges from the typical velocities in dSphs (\(\sim 10^{-5} \)) to the speed of light.}
