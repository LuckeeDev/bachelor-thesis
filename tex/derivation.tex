...
This first part of the solution is an extension of the calculations reported by Arkani-Hamed et al. in \cite{Arkani_2009}, with details of quantum scattering theory taken from two quantum mechanics textbooks: Griffiths \cite{Griffiths} and Cohen-Tannoudji et al. \cite{Cohen-Tannoudji}.
...
A more detailed discussion of the experimental implications is left for Chapter \ref{chap:implications}, however, one can look ahead at Figure \ref{fig:enhancement_factor} to visualize the impact of the Sommerfeld enhancement factor obtained in Eq. \eqref{eq:result}. As one can see from the colormap, it can enhance the annihilation cross-section by up to \(4-5\) orders of magnitude at low velocities and high masses.