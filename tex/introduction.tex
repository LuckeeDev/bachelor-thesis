...
The goal is to apply \cite{Arkani_2009} and see the experimental implications on \cite{Profumo_2018}. The whole thesis uses natural units where \(c=\hbar=G=1\). The code I wrote is open-source on \href{GitHub}{https://github.com/LuckeeDev/bachelor-thesis}.
